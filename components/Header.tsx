...
import logo from "@/public/images/logo/logo-ash.png"
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="py-2 border-b border-gray-800 flex justify-between items-center">
          <div className="flex space-x-4">
            <a href="#" className="text-sm hover:text-gold">+91 1234567890</a>
            <a href="#" className="text-sm hover:text-gold">info@newfancyjewellers.com</a>
          </div>
          <div className="flex space-x-4">
